...
export const HomepageHighlightAgenciesListItemSchema = z.array(
  z.object({
    id: z.string(),
    image: z.string(),
    name: z.string(),
...
export const getHighlightAgenciesList = async <ResponseType = HomepageHighlightAgenciesListResponse>(params?: {
