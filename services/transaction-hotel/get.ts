...
export const TransactionHotelListParamsSchema = z.object({
...
export type TransactionHotelListParams = z.infer<typeof TransactionHotelListParamsSchema>

// Define the schema for an individual transaction Hotel item
export const TransactionHotelListItemSchema = z.object({
  id: z.string(),
  ...
  hotel_vendor: z.any().nullable(),
})
export type TransactionHotelListItem = z.infer<typeof TransactionHotelListItemSchema>

// Build the schema for the list response using the item schema
export const TransactionHotelListResponseSchema = httpGetListResponseSchemaBuilder(TransactionHotelListItemSchema)
export type TransactionHotelListResponse = z.infer<typeof TransactionHotelListResponseSchema>

// Function to fetch the list of transaction Hotel
export const getList = async <ResponseType = TransactionHotelListResponse>({
  params,
  options,
}: {
  ...
  const response: AxiosResponse<ResponseType> = await apiCall({
    ...
    ...options,
    method: 'get',
    url: '/v1/orders?sort_by=desc&order_by=created_at&type=hotel',
  })
