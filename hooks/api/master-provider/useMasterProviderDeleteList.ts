...
export const useMasterProviderDeleteList = (opt?: useMasterProviderListConfig) => {
  const {
    queryKey = [queryKeyMasterProvider.MASTER_PROVIDER_LIST_DELETE],
    params = { page: 1, page_size: 10, export_data: false, is_deleted: true },
    options,
  } = opt ?? {}
