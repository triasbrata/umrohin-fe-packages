...
export const PackageFlightTicketCreateItemBodySchema = zfd.formData({
  ...
  arrived_date: z.any(),
  departure_time: z.any().optional().nullable(),
  arrived_time: z.any().optional().nullable(),
  class_id: zfd.text(),
  price: zfd.numeric(),
  ...
  back_departure_time: z.any().optional().nullable(),
  back_arrived_date: z.any(),
  back_arrived_time: z.any().optional().nullable(),
